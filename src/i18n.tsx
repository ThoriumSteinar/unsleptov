...
const dict: Record<Lang, Copy> = {
  ru: {
    ...
    work: {
      index: '03',
      title: 'релизы',
      lead: 'три живых кейса: AU-редизайн, grill-бар и ресторан eatbu-style.',
      ...
      items: [
        ...
        },
        {
          id: '03',
          tag: 'HOSPITALITY',
          name: 'UNSLEPTOV.GRILL',
          text: 'Ресторан в стиле eatbu: тёмный хедер, бронь, меню, галерея, PT/EN/RU. Фиктивные данные unsleptov — портфолио-демо.',
          stack: 'TypeScript · React · GH Pages',
          live: 'https://thoriumsteinar.github.io/unsleptov-restaurant-bar/',
          repo: 'https://github.com/ThoriumSteinar/unsleptov-restaurant-bar',
        },
      ],
    },
    contact: {
  ...
  en: {
    ...
    work: {
      index: '03',
      title: 'releases',
      lead: 'three live cases: AU redesign, grill bar, and an eatbu-style restaurant.',
      ...
      items: [
        ...
        },
        {
          ...
          tag: 'HOSPITALITY',
          name: 'UNSLEPTOV.GRILL',
          text: 'Eatbu-style restaurant: dark header, booking, menu, gallery, PT/EN/RU. Fictional unsleptov data — portfolio demo.',
          stack: 'TypeScript · React · GH Pages',
          live: 'https://thoriumsteinar.github.io/unsleptov-restaurant-bar/',
          repo: 'https://github.com/ThoriumSteinar/unsleptov-restaurant-bar',
        },
